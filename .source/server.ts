...
import { default as __fd_glob_2 } from "../content/docs/account/meta.json?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "billing/meta.json": __fd_glob_1, "account/meta.json": __fd_glob_2, "getting-started/meta.json": __fd_glob_3, "workspaces/meta.json": __fd_glob_4, }, {"index.mdx": __fd_glob_5, "account/notifications.mdx": __fd_glob_6, "account/profile.mdx": __fd_glob_7, "billing/index.mdx": __fd_glob_8, "getting-started/index.mdx": __fd_glob_9, "workspaces/index.mdx": __fd_glob_10, "workspaces/invite-team.mdx": __fd_glob_11, "workspaces/roles-permissions.mdx": __fd_glob_12, });