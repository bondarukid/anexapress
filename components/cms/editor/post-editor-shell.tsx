          ...
          contentTab={
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="editor-slug" value={slug} onChange={(e) => setSlug(e.target.value)} disabled />
                <p className="text-muted-foreground text-xs">Slug editing in a future update.</p>
              </div>
            </div>
          }
          seoTab={<SeoPanel seo={seo} onChange={setSeo} workspaceId={post.workspaceId} />}
          mediaTab={
