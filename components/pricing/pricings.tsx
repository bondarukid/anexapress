  ...
  return (
    <div className="not-prose @container flex flex-col gap-16 px-8 py-24 text-center">
      <div className="flex flex-col items-center justify-center gap-8">
        ...
        <p className="text-muted-foreground mx-auto mt-0 mb-0 max-w-2xl text-lg text-balance">
        ...
        <div className="mt-8 grid w-full max-w-4xl gap-4 @2xl:grid-cols-3">
          {plans.map((plan) => (
            ...
            >
              {plan.popular ? (
                <Badge className="absolute top-0 left-1/2 z-20 -translate-x-1/2 -translate-y-1/2 rounded-full shadow-sm">
                  Popular
                </Badge>
              ) : null}
              <CardHeader className={cn(plan.popular && "pt-10")}>
              ...
              <CardContent className="grid gap-2">
                {plan.features.map((feature, index) => (
                  <div className="text-muted-foreground flex gap-2 text-sm" key={index}>
