...
import type { SocialPlatformId } from "@/types/social-platform";
...
const platformIcons: Record<SocialPlatformId, ComponentType<IconProps>> = {
...
export function SocialPlatformIcon({ platformId, className, style }: SocialPlatformIconProps) {
