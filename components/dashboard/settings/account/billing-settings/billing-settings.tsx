...
export type UserProfileBillingProps = {
  className?: string;
};

export function BillingSettings({ className }: UserProfileBillingProps) {
  return (
    <div className={cn("container mx-auto px-4 py-6 md:px-6 2xl:max-w-[1400px]", className)}>
          ...
          <CardContent className="p-6">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div>
                <div className="mb-2 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <RefreshCwIcon className="text-primary size-4" />
            ...
            <div className="flex flex-col items-start justify-between gap-4 sm:flex-row">
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-muted-foreground text-sm">Visa ending in 4242</span>
                </div>
              </div>
